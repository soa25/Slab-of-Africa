...
export const recentAdditions: Artwork[] = [
  ...
  // 5
  {
    ...
    size: '19 × 15 in',
    year: 2024,
    image: '/images/recent/bonded-souls.jpg',
    aspectRatio: 'portrait',
    featured: true,
    description: 'Placeholder description for this work.',
    images: [
      '/images/recent/bonded-souls.jpg',
  ...
  // 6
  {
    ...
    size: '27.5 × 16.5 in',
    year: 2024,
    image: '/images/recent/lovers.jpg',
    aspectRatio: 'portrait',
    description: 'Placeholder description for this work.',
    images: [
      '/images/recent/lovers.jpg',
  ...
  // 7
  {
    ...
    size: '24 × 11 × 8.5 in',
    year: 2024,
    image: '/images/recent/abstract-taf.jpg',
    aspectRatio: 'portrait',
    description: 'Placeholder description for this work.',
    images: [
      '/images/recent/abstract-taf.jpg',
  ...
  // 9
  {
    ...
    size: '22 × 8.5 in',
    year: 2024,
    image: '/images/recent/riches-of-true-love.jpg',
    aspectRatio: 'portrait',
    description: 'Placeholder description for this work.',
    images: [
      '/images/recent/riches-of-true-love.jpg',
  ...
  // 17
  {
    ...
    size: '32 × 13.5 in',
    year: 2024,
    image: '/images/recent/abstract-gra.jpg',
    aspectRatio: 'portrait',
    description: 'Placeholder description for this work.',
    images: [
      '/images/recent/abstract-gra.jpg',
